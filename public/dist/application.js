...
var ApplicationConfiguration = (function() {
	...
	var applicationModuleName = 'enterpriseapp';
...
angular.module('users').run(['Menus',
    function (Menus) {
        // Set top bar menu items
        Menus.addMenuItem('topbar', 'Users', 'users', 'dropdown', '/users/profiles(/create)?', false, ['user', 'superadmin']);
        Menus.addSubMenuItem('topbar', 'users', 'List Users', 'users/profiles/list');
        Menus.addSubMenuItem('topbar', 'users', 'New User', 'users/profiles/create');
    }
]);
'use strict';
